...
rbac_update(){
    ...
    rm -rf rbac
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/rbac-${DOMAIN_NAME}-*.tar.gz
}
...
workbench_update(){
    ...
    rm -rf workbench
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/workbench-${DOMAIN_NAME}-*.tar.gz
}
...
cmdb_update(){
    ...
    rm -rf cmdb
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/cmdb-${DOMAIN_NAME}-*.tar.gz
}
...
control_update(){
    ...
    rm -rf control
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/control-${DOMAIN_NAME}-*.tar.gz
}
...
job_update(){
    ...
    rm -rf job
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/job-${DOMAIN_NAME}-*.tar.gz
}
...
monitor_update(){
    ...
    rm -rf monitor
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/monitor-${DOMAIN_NAME}-*.tar.gz
}
...
cmp_update(){
    ...
    rm -rf cmp
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/cmp-${DOMAIN_NAME}-*.tar.gz
}
...
devops_update(){
    ...
    rm -rf devops
    cd $CDIR
    python3 ../saas/deploy.py --domain $DOMAIN_NAME --username admin --password $ADMIN_PASSWORD --file_name ../saas/devops-${DOMAIN_NAME}-*.tar.gz
}
