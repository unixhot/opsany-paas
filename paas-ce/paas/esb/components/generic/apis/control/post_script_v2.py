...
class PostScriptV2(Component):
    ...
    class Form(BaseComponentForm):
        ...
        def clean(self):
            return self.get_cleaned_data_when_exist(keys=["instances", "script_url", "args", "run_user"])
    ...
    def handle(self):
        ...
        response = self.outgoing.http_client.post(
            host=configs.host,
            path='{}script-v2/'.format(base_api_url.replace("api/control/v0_1/", "api/execution/v0_1/")),
