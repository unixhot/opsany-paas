...
class GetAlert(Component):
    ...
    | alert_type | string | 否  | 告警类型 node：主机组件告警 blackbox：服务拨测告警 all：全部告警 |
    ...
    class Form(BaseComponentForm):
        ...
        page_size = forms.Field(required=False)
        ...
        def clean(self):
            return self.get_cleaned_data_when_exist(keys=["page", "page_size", "alert_type", "severity", "params"])
